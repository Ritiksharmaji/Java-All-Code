  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="#"> <span class="	fa fa-check-square"></span> learnCode with Ritik <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="Login_jsp.jsp"> <span class="fa fa-user-circle"></span> Login</a>
      </li>
      <li class="nav-item">
